package vis.proth.repository;

import vis.proth.JhipsterProthApp;
import vis.proth.config.Constants;
import vis.proth.config.audit.AuditEventConverter;
import vis.proth.domain.PersistentAuditEvent;
...
import static vis.proth.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
