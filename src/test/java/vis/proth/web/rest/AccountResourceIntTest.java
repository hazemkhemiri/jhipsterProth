package vis.proth.web.rest;

import vis.proth.config.Constants;
import vis.proth.JhipsterProthApp;
import vis.proth.domain.Authority;
import vis.proth.domain.User;
import vis.proth.repository.AuthorityRepository;
import vis.proth.repository.UserRepository;
import vis.proth.security.AuthoritiesConstants;
import vis.proth.service.MailService;
import vis.proth.service.dto.UserDTO;
import vis.proth.web.rest.errors.ExceptionTranslator;
import vis.proth.web.rest.vm.KeyAndPasswordVM;
import vis.proth.web.rest.vm.ManagedUserVM;
import vis.proth.service.UserService;
...
@SpringBootTest(classes = JhipsterProthApp.class)
